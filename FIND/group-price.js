// regex: currency symbol/letters + digits + '.' + digits
// without regex we would scan characters and slice around the dot
// good to remember: capturing groups let us return full, integer, and decimal parts separately

// groupPrice: finds all prices and returns [full, integer, decimal] for each
export function groupPrice(str) {
  // ([$A-Za-z]+) currency (e.g. USD or $), (\d+) integer, (\d+) decimal
...
console.log(groupPrice('EUR9.99 and $100.05 and USD0.30'))
// [["EUR9.99","9","99"], ["$100.05","100","05"], ["USD0.30","0","30"]]
